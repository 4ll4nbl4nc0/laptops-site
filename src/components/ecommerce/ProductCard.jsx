      ...
      <Card
        sx={{
          ...
          '&:hover': {
            ...
            borderColor: 'rgba(47, 127, 121, 0.18)',
            boxShadow: '0 24px 56px rgba(177, 141, 108, 0.16)',
          },
        }}
      >
        <Box sx={{ position: 'relative' }}>
          <CardMedia
            ...
            alt={product.name}
            sx={{
              width: view === 'list' ? { xs: '100%', md: 360 } : '100%',
              aspectRatio: view === 'list' ? '16 / 10' : '16 / 11',
              objectFit: 'cover',
            }}
          />
          <Box
            sx={{
              ...
              inset: 0,
              background:
                'linear-gradient(180deg, rgba(255,255,255,0) 42%, rgba(251,246,239,0.82) 100%)',
            }}
          />
        </Box>
        <CardContent sx={{ flex: 1, p: 3 }}>
          <Stack spacing={2.2} height="100%">
            ...
            <Stack direction="row" spacing={1.5} alignItems="center">
              <StarRoundedIcon sx={{ color: '#ea7a5a' }} />
